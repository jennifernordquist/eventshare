...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { email: @recipient.email, facebook_id: @recipient.facebook_id, name: @recipient.name, phone: @recipient.phone, rsvp: @recipient.rsvp }
    end
  ...
  test "should update recipient" do
    put :update, id: @recipient, recipient: { email: @recipient.email, facebook_id: @recipient.facebook_id, name: @recipient.name, phone: @recipient.phone, rsvp: @recipient.rsvp }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
